...
| 2 | コマンドー（Commandos） | 数字が大きい方が勝ち。同数は引き分け。 |
| 3 | 騎兵隊（Cavalry） | 同上 |
| 4 | 大隊（Battalion） | 同上 |
...
| むずかしさ | 中身 |
| --- | --- |
| やさしい | 鉱山ごとに「相手が何を置いてきそうか」の予想と理由を表示。相手の手もぶれやすい。 |
| ふつう | 予想なし。相手はいつもの打ち筋。 |
...
- 下段：自分の札（つねに表向き）
- 左右：縦書きの名前と ◆ 得点
- 鉱山の下に、そのラウンドの結果を `WIN` / `LOSE` / `DRAW` で表示
...
積み増しされた鉱山は「計💎10／💎5の鉱山が2枚」のように、合計と内訳を分けて表示します。
